...
Q_CONSTINIT const QMetaObject PlayerController::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16PlayerControllerE_t,
        ...
        // method 'playlistAvailabilityChanged'
...
void PlayerController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->playlistAvailabilityChanged((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 1: _t->OnChooseMusic((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (PlayerController::*)(bool );
            if (_q_method_type _q_method = &PlayerController::playlistAvailabilityChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PlayerController::playlistAvailabilityChanged(bool _t1)
{
